...
void txMessage(uint8_t command){
  uint8_t b[PACKET_LENGTH];

  // write code to fill the packet buffer with the
  // command byte
...
void loop()
{
  // write code to send a clear screen command

  delay(1000);

  // write code to send a checkers command

  delay(1000);

  // write code to send a fill screen command
